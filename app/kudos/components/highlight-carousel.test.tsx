...
function makeKudos(id: string, senderName: string): KudosCardType {
  return {
    ...
    title: "",
    isAnonymous: false,
    sender: { id: `${id}-s`, fullName: senderName, department: "CECV10", avatarUrl: "", title: "", starTier: 1, heroBadge: "new" },
    receiver: { id: `${id}-r`, fullName: "Receiver", department: "CECV10", avatarUrl: "", title: "", starTier: 3, heroBadge: "legend" },
    content: "Content",
