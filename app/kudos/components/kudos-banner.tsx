 ...
 * the `/kudos` board's own keyvisual art — a colorful organic swirl
 * (extracted from the MoMorph "MM_MEDIA_KV Background" node, distinct from
 * the homepage teaser's dark/gold-arc `/home/kudos-bg.png`, which was
 * incorrectly reused here before) — plus the two function pills below it
 * (`Button chuc nang`): "send Kudos" (compose trigger stub) and "search
 * Sunner" (search trigger stub). Neither pill opens real UI here — both
