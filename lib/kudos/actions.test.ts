...
const CARD: KudosCard = {
  ...
  title: '',
  isAnonymous: false,
  sender: { id: 's1', fullName: 'Sender', department: '', avatarUrl: '', title: '', starTier: 0, heroBadge: 'none' },
  receiver: { id: 'r1', fullName: 'Receiver', department: '', avatarUrl: '', title: '', starTier: 0, heroBadge: 'none' },
  content: 'nice work',
