...
export const DEPARTMENTS = ["CEVC2", "CEVC3", "CEVC4", "CEVC1", "OPD", "Infra"] as const;
...
const DESIGN_SUNNERS: SeedSunner[] = [
  { email: "huynh.duong.xuan@seed.saa.local", fullName: "Huỳnh Dương Xuân", avatarUrl: "https://i.pravatar.cc/150?u=huynh-duong-xuan", departmentName: "CEVC2", title: "Legend Hero" },
  { email: "do.hoang.hiep@seed.saa.local", fullName: "Đỗ Hoàng Hiệp", avatarUrl: "https://i.pravatar.cc/150?u=do-hoang-hiep", departmentName: "CEVC3", title: "Super Hero" },
  { email: "duong.thuy.an@seed.saa.local", fullName: "Dương Thúy An", avatarUrl: "https://i.pravatar.cc/150?u=duong-thuy-an", departmentName: "CEVC4", title: "Rising Hero" },
  { email: "mai.phuong.thuy@seed.saa.local", fullName: "Mai Phương Thúy", avatarUrl: "https://i.pravatar.cc/150?u=mai-phuong-thuy", departmentName: "CEVC1", title: "New Hero" },
  { email: "nguyen.van.quy@seed.saa.local", fullName: "Nguyễn Văn Quy", avatarUrl: "https://i.pravatar.cc/150?u=nguyen-van-quy", departmentName: "CEVC2", title: "Rising Hero" },
  { email: "le.kieu.trang@seed.saa.local", fullName: "Lê Kiều Trang", avatarUrl: "https://i.pravatar.cc/150?u=le-kieu-trang", departmentName: "CEVC3", title: "New Hero" },
  { email: "nguyen.ba.chuc@seed.saa.local", fullName: "Nguyễn Bá Chức", avatarUrl: "https://i.pravatar.cc/150?u=nguyen-ba-chuc", departmentName: "CEVC4", title: "Super Hero" },
  { email: "nguyen.hoang.linh@seed.saa.local", fullName: "Nguyễn Hoàng Linh", avatarUrl: "https://i.pravatar.cc/150?u=nguyen-hoang-linh", departmentName: "CEVC1", title: "Legend Hero" },
];
