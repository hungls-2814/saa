...
- **Consumer:** takumi code-discipline Stage 0 Promote — copies the draft to `docs/features/`,
...
spec already exists in `docs/features/` and is NOT being revised.

```yaml
spec: docs/features/F###_slug/   # relative path, within docs/ tree — no absolute/traversal paths
```
