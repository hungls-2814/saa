...
2. **Step B — Rebuild-spec shape:** a `docs/generated/feature-list.md` means you're in the v4.0.0 layered layout, and that file is your front door for feature work.
