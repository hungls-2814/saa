...
> A set of polished landing-page components in React & Tailwind CSS — 80+ of them.
...
To pull up usage docs, run the `tkm:search-docs` skill against Context7:
```
context7 query: "magicui <component-name> usage example"
```

For a working source example, grab it from GitHub:
```
