...
Review ${mode === "incremental" ? "re-generated core" : "core"} artifacts: ${mode === "incremental" ? re_generated_artifacts.join(', ') : "system-overview, architecture, route-list, data-model, screen-list, screen-flow, behavior-logic, permissions, permissions-matrix, user-stories, feature-list"}.
...
// [v5.1.0] docs_root threaded from language dispatch (en→"docs", else "docs/<primary_lang>").
bash: .claude/skills/.venv/bin/python3 \
...
const coreDocsToAssert = [
  ...
  `${docs_root}/generated/route-list.md`, `${docs_root}/generated/api-map.md`,
  ...
  `${docs_root}/generated/screen-list.md`, `${docs_root}/generated/screen-flow.md`,
...
Promote passing drafts to layered docs/ paths per claude/skills/_shared/docs-canonical-mapping.md:
  ...
  generated/ ← route-list.md, api-map.md, permissions-matrix.md, entities.md, user-stories.md, feature-list.md, screen-list.md, screen-flow.md, behavior-logic.md
