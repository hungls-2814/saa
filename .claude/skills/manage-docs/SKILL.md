...
- Canonical docs mapping: `claude/skills/_shared/docs-canonical-mapping.md` — layered model (`docs/system/`, `docs/generated/`, `docs/features/`, `docs/flows/`) and surgical-edit policy
