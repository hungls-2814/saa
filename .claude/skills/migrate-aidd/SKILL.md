...
4. Ensure output dirs: `docs/system/`, `docs/generated/`, `docs/flows/`,
...
| W9 | `doc-writer` | promoted drafts | `docs/system/`, `docs/generated/`, `docs/flows/`, `docs/features/{slug}/` + wave9 flag |
